package com.enoca.challenge.redis;
...
public class RedisConfig {
    ...
    public RedisCacheManagerBuilderCustomizer redisCacheManagerBuilderCustomizer() {
        return builder -> {
            var productConfig = RedisCacheConfiguration.defaultCacheConfig()
                    .entryTtl(Duration.ofMinutes(post));

            builder.withCacheConfiguration(Constant.REDIS_PRODUCT_CLASS, productConfig);
        };
    }
}
